        ...
        return http
                ...
                .exceptionHandling(errors -> errors
                    .accessDeniedHandler((req,res,e)->{
                        ...
                        ErrorResponse body = e instanceof MissingCsrfTokenException || e instanceof InvalidCsrfTokenException
                ...
                .oauth2ResourceServer(o->o.bearerTokenResolver(cookieResolver()).jwt(Customizer.withDefaults())
                    .authenticationEntryPoint((req,res,e)->{res.setStatus(401);res.setContentType("application/json");mapper.writeValue(res.getOutputStream(),new ErrorResponse("인증이 필요합니다."));}))
