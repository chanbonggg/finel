...
PostgreSQL 모범 사례 빠른 참고 문서. 상세한 안내는 `database-reviewer` 에이전트를 사용하세요.
...
- 에이전트: `database-reviewer` - 전체 데이터베이스 검토 워크플로우
- 스킬: `clickhouse-io` - ClickHouse 분석 패턴
- 스킬: `backend-patterns` - API 및 백엔드 패턴

---

*Supabase Agent Skills 기반 (제작: Supabase 팀) (MIT License)*
