...
export async function getFeaturedProducts(limit=4):Promise<Product[]>{return (await readJson<ProductsResponse>(await apiFetch(`/api/products/featured?limit=${limit}`,{next:{revalidate:300}}))).products;}
